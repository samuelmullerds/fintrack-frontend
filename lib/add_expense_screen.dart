...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (ok) {
        setState(() {
          _successMessage = 'Gasto adicionado com sucesso! ✓';
          _amountStr = '0';
  ...
  Future<void> _pickFromList(List<String> options, ValueChanged<String> onPick) async {
    String? current = options.contains(_selectedCategory) ? _selectedCategory : null;
